...
def test_cov_hessian_with_probit(setup_covariance_matrices, 
                                 expected_covariance_matrices):
...
def test_cov_hessian_with_logit(setup_covariance_matrices, 
                                 expected_covariance_matrices):
    inputs, outputs = setup_covariance_matrices, expected_covariance_matrices
    covariance_matrix = cov_hessian(inputs['logit_hessian_matrix'])
    aaae(covariance_matrix, outputs['logit_hessian_cov'])
    
def test_cov_jacobian_with_probit(setup_covariance_matrices, 
                                 expected_covariance_matrices):
    inputs, outputs = setup_covariance_matrices, expected_covariance_matrices
    covariance_matrix = cov_jacobian(inputs['probit_jacobian_matrix'])
    aaae(covariance_matrix, outputs['probit_jacobian_cov'])
    
def test_cov_jacobian_with_logit(setup_covariance_matrices, 
                                 expected_covariance_matrices):
    inputs, outputs = setup_covariance_matrices, expected_covariance_matrices
    covariance_matrix = cov_jacobian(inputs['logit_jacobian_matrix'])
    aaae(covariance_matrix, outputs['logit_jacobian_cov'])
    
def test_cov_sandwich_with_probit(setup_covariance_matrices, 
                                 expected_covariance_matrices):
    inputs, outputs = setup_covariance_matrices, expected_covariance_matrices
    covariance_matrix = cov_sandwich(inputs['probit_jacobian_matrix'],
                                     inputs['probit_hessian_matrix'])
    aaae(covariance_matrix, outputs['probit_sandwich_cov'])


def test_cov_sandwich_with_logit(setup_covariance_matrices, 
                                 expected_covariance_matrices):
    inputs, outputs = setup_covariance_matrices, expected_covariance_matrices
    covariance_matrix = cov_sandwich(inputs['logit_jacobian_matrix'],
                                     inputs['logit_hessian_matrix'])
